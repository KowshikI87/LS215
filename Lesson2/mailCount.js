...
/*
//I would not know how to do the following:

  //Line 17 where we split by ' ' first.
    //I guess we could have tried trial and error

  //Line 18 where JS month is from 0 to 1

  //date.valueOf() to sort the dates
